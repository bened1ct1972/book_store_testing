...
shop_link.click()
# entering in HTML section
driver.find_element_by_link_text('HTML').click()
uls_shop = driver.find_elements_by_css_selector(".instock.taxable.shipping-taxable.purchasable.product-type-simple")
assert len(uls_shop) == 3
